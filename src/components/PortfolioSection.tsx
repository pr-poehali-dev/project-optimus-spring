...
const projects = [
  {
    ...
    description:
      "Сайт кофейни в Кургане с расширенным меню, отзывами и онлайн-заказом. Гости выбирают напитки и десерты прямо на сайте.",
  ...
  },
  {
    ...
    description:
      "Сайт автосервиса в Кургане с командой мастеров, отзывами и онлайн-записью на диагностику.",
  ...
  },
  {
    ...
    description:
      "Сайт автомойки в Кургане с тарифами, абонементами и онлайн-записью на удобное время.",
    url: "/demo/car-wash",
  ...
  },
  {
    ...
    description:
      "Интернет-магазин в Кургане с каталогом из 20+ товаров, рейтингами, фильтрами и корзиной.",
